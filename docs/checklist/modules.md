...
```kotlin
implementation("com.github.adzcsx2.android-common-lib:common-network:1.2.6")
```
...
```kotlin
implementation("com.github.adzcsx2.android-common-lib:common-image:1.2.6")
```
...
```kotlin
implementation("com.github.adzcsx2.android-common-lib:common-core:1.2.6")
```
...
```kotlin
implementation("com.github.adzcsx2.android-common-lib:common-utils:1.2.6")
```
...
```kotlin
implementation("com.github.adzcsx2.android-common-lib:common-ui:1.2.6")
```
...
```kotlin
implementation("com.github.adzcsx2.android-common-lib:common-base:1.2.6")
```
...
```kotlin
implementation("com.github.adzcsx2.android-common-lib:common-compose:1.2.6")
```
