...
dependencies {
    // 只引入需要的模块，减少 APK 体积
    implementation("com.github.adzcsx2.android-common-lib:common-core:1.1.0")      // 核心基础模块
    implementation("com.github.adzcsx2.android-common-lib:common-base:1.1.0")      // 架构基础模块
    implementation("com.github.adzcsx2.android-common-lib:common-utils:1.1.0")     // 工具类扩展
    implementation("com.github.adzcsx2.android-common-lib:common-compose:1.1.0")   // Compose 组件
    implementation("com.github.adzcsx2.android-common-lib:common-network:1.1.0")   // 网络请求
    implementation("com.github.adzcsx2.android-common-lib:common-image:1.1.0")     // 图片加载
    implementation("com.github.adzcsx2.android-common-lib:common-ui:1.1.0")        // UI 组件
}
```
