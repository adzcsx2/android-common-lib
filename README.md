...
dependencies {
    // 只引入需要的模块，减少 APK 体积
    implementation("com.github.adzcsx2:common-core:1.0.3")      // 核心基础模块
    implementation("com.github.adzcsx2:common-base:1.0.3")      // 架构基础模块
    implementation("com.github.adzcsx2:common-utils:1.0.3")     // 工具类扩展
    implementation("com.github.adzcsx2:common-compose:1.0.3")   // Compose 组件
    implementation("com.github.adzcsx2:common-network:1.0.3")   // 网络请求
    implementation("com.github.adzcsx2:common-image:1.0.3")     // 图片加载
    implementation("com.github.adzcsx2:common-ui:1.0.3")        // UI 组件
}
```
...
dependencies {
    // 引入所有模块
    implementation("com.github.adzcsx2:android-common-lib:1.0.3")
}
```
...
| `1.0.3` | 固定版本，对应 `1.0.3` tag |
| `-SNAPSHOT` | master 分支的最新提交 |
| `1.0.3-SNAPSHOT` | 1.0.3 tag 之后的最新提交 |
...
- **固定版本 (1.0.0, 1.0.3)**: 永远对应那个 tag 的代码，不会变
...
# 提交更改
git add .
git commit -m "chore: 版本更新至 1.0.3"
...
dependencies {
    implementation("com.github.adzcsx2:common-core:1.0.3")
}
```
